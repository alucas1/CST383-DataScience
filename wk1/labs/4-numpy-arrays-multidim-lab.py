...
# ANSWER: Yes, it is legal. The array with shape (35,) will be converted to
# shape (1, 35). This single row will then be copied 50 times to become shape
# (50, 35). The two arrays are now the same size and can be subrtacted.
...
# ANSWER: I expect the average to be 0 as a result of the centering
